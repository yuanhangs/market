<%@ page import="org.aly.sjc.entity.UserInfoAndType" %>
...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <%
                //获得数据
                List<UserInfoAndType> lists= (List<UserInfoAndType>) request.getAttribute("lists");
                int i=0;
                //循环
                for(UserInfoAndType user:lists){
            %>
            <tr align="center">
                <td ><%=user.getUserId()%></td>
                <td><%=user.getUserName()%></td>
                <td><%=((user.getSex()==1)?("男"):("女"))%></td>
                <td><%=user.getBornDate()%></td>
                ...
                <td>
                    ...
                    <%--<a href="removeUser.user?delUserId=<%=user.getUserId()%>" class="removeUser"><img src="img/schu.png" alt="删除" title="删除"/></a>--%>
                    <%--<a href="#" class="removeUser"  onclick="funDel('<%=user.getUserId()%>')"><img src="img/schu.png" alt="删除" title="删除"/></a>--%>
                     <input type="hidden" name="uid<%=i%>" value="<%=user.getUserId()%>"/>
